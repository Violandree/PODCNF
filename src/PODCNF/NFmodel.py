...
class CouplingLayer(nn.Module):
    ...
    def __init__(self, dim_x, dim_y, hidden_size=256, hidden_depth=1):
        super().__init__()
    ...
    def forward(self, x, z, ldj, reverse=False):
...
class NormalizingFlow(nn.Module):
    ...
    def __init__(self, dim_x, dim_y, num_flows=8, hidden_size=256, hidden_depth=1, device = 'cuda'):
        super().__init__()
        self.flows = nn.ModuleList([CouplingLayer(dim_x, dim_y, hidden_size, hidden_depth) for _ in range(num_flows)])
